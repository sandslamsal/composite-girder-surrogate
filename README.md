...
The full dataset (48,917 sections, 3.9 × 10⁶ rows, ~200 MB) is not
shipped here. It is regenerated deterministically from the released
code in roughly twelve minutes via `scripts/generate_dataset.py`.
